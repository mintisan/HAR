...
def run_experiment(data_dir=""):
    ...
    plot_model(model, to_file='./keras_lstm_har_model.png', show_shapes=True)  # model structure
    model.save('keras_lstm_har_model.h5')  # model
    netron.start('keras_lstm_har_model.h5')  # model structure
    ...
    plt.xlabel('epoch')
    plt.savefig("keras_lstm_har_model_epoch" + '.png')
    # plt.show()
    plt.close()
    plt.clf()
